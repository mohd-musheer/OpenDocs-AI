...
in your path operation function (as you can do for cookies).
...
Return a Response
directly¶
You can also add headers when you return a Response
directly.
...
prefix.
But if you have custom headers that you want a client in a browser to be able to see, you need to add them to your CORS configurations (read more in CORS (Cross-Origin Resource Sharing)), using the parameter expose_headers
