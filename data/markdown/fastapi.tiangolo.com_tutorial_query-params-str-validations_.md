...
can be used to add metadata to your parameters in the Python Types Intro?
...
¶
Using Annotated
is recommended instead of the default value in function parameters, it is better for multiple reasons. 🤓
...
Because Annotated
can have more than one metadata annotation, you could now even use the same function with other tools, like Typer. 🚀
...
You can achieve that using Pydantic's AfterValidator
inside of Annotated
.
Tip
Pydantic also has BeforeValidator
and others. 🤓
...
The important point is just using AfterValidator
with a function inside Annotated
