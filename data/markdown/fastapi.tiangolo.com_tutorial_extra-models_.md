...
.
Pydantic models have a .model_dump()
...
, Python will "unpack" it. It will pass the keys and values of the user_dict
...
from user_in.model_dump()
, this code:
user_dict = user_in.model_dump()
UserInDB(**user_dict)
would be equivalent to:
UserInDB(**user_in.model_dump())
...because user_in.model_dump()
is a dict
, and then we make Python "unpack" it by passing it to UserInDB
prefixed with **
.
...
Warning
The supporting additional functions fake_password_hasher
and fake_save_user
