...
is called with a username that doesn't exist in the database, we still run verify_password
...
, you will see how the hashed password looks like now: "$argon2id$v=19$m=65536,t=3,p=4$wagCPXjifgvUFBzq4hqe3w$CYaIb8sB+wtD+Vu/P4uod1+Qof8h+1g7bbDlBID48Rc"
.
Handle JWT tokens¶
...
.
The important thing to keep in mind is that the sub
...
And you can use directly many well maintained and widely used packages like pwdlib
and PyJWT
