...
¶
Note
This requires installing a2wsgi
for example with pip install a2wsgi
.
...
Note
Previously, it was recommended to use WSGIMiddleware
from fastapi.middleware.wsgi
, but it is now deprecated.
It’s advised to use the a2wsgi
package instead. The usage remains the same.
Just ensure that you have the a2wsgi
package installed and import WSGIMiddleware
correctly from a2wsgi
.
Check it¶
